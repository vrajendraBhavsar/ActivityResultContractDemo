...
import com.example.activityresultcontractdemo.Contract.Companion.REQ_KEY
...
class MainActivity : AppCompatActivity() {
    ...
    private val contract = registerForActivityResult(Contract()) { outputString ->
        outputString?.let {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fab.setOnClickListener { view ->
            if (!etContentText.isNullOrEmpty()) {
                contract.launch(etContentText.toString())
            } else {
